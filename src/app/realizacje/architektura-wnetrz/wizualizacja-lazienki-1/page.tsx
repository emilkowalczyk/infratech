...
function WizualizacjaLazienki1() {
    const images = ['/images/architektura-wnetrz/wizualizacja-lazienki-1/1.webp', '/images/architektura-wnetrz/wizualizacja-lazienki-1/2.webp', '/images/architektura-wnetrz/wizualizacja-lazienki-1/3.webp']
    return (
