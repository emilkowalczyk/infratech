...
function WizualizacjaLazienki1() {
    const images = ['/images/architektura-wnetrz/wizualizacja-lazienki-1/1.jpg', '/images/architektura-wnetrz/wizualizacja-lazienki-1/2.jpg', '/images/architektura-wnetrz/wizualizacja-lazienki-1/3.jpg']
    return (
