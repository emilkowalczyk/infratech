...
function WizualizacjaEON() {
    const images = ['/images/architektura-wnetrz/wizualizacja-e-on/1.jpg', '/images/architektura-wnetrz/wizualizacja-e-on/2.jpg', '/images/architektura-wnetrz/wizualizacja-e-on/3.jpg']
    return (
