...
function HeroSection({bgImage, heading, description, btnLabel, btnPath}: Props) {
    return (
        <header className='w-full flex flex-col h-[780px]'>
            ...
            />
            <div
                className='h-full flex flex-col justify-center items-center md:items-start px-5 md:max-w-7xl md:mx-auto md:w-full'>
                ...
                <Button path={btnPath} label={btnLabel}/>
            </div>
        </header>
    );
}
